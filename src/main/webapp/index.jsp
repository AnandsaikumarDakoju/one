...
<body>
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                <button class="mobile-toggle" id="mobileToggle" aria-label="Open menu"> class="fas fa-bars"></em></button>
                <a class="brand" href="#">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    <li><a href="#"> class="fas fa-home"></em> Home</a></li>
                    <li class="has-dropdown" aria-haspopup="true">
                        <a href="#" id="catMenuBtn"> class="fas fa-th-large"></em> Categories  class="fas fa-chevron-down" style="font-size:12px;"></em></a>
                    </li>
                    <li><a href="#"> class="fas fa-fire"></em> Trending</a></li>
                    <li><a href="#deals"> class="fas fa-tag"></em> Deals</a></li>
                    <li><a href="#about"> class="fas fa-info-circle"></em> About</a></li>
                </ul>
            </nav>

            <div style="display:flex;align-items:center;gap:14px;">
                <div class="search" role="search" aria-label="Product search">
                    nput type="search" id="searchInput" placeholder="Search products, categories..." aria-label="Search products" />
                    <button class="icon-btn" id="searchBtn" aria-label="Search"> class="fas fa-search"></em></button>
                </div>

                <div class="header-actions" role="group" aria-label="Header actions">
                    <a class="icon-btn" title="Account" href="#"> class="far fa-user"></em></a>
                    <a class="icon-btn" title="Wishlist" href="#"> class="far fa-heart"></em></a>
                    <a class="cart" href="#" id="cartBtn" title="View cart" aria-label="Cart">
                         class="fas fa-shopping-cart"></em>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Kailash Tech in Telugu And AI Agents</h1>
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Shop Now  class="fas fa-arrow-right"></em></button>
        ...
        <section id="deals" class="section container" aria-labelledby="deals-title">
            ...
            <div class="deal" style="align-items:stretch;">
                mg src="https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=1200&q=80" alt="Deal product">
                <div class="content">
            ...
            <div class="testimonials" id="testimonials">
                <div class="testimonial">
                    ...
                    <div style="display:flex;align-items:center;gap:10px">
                        mg src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=80&q=80" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit:cover">
                        <div>
                ...
                <div class="testimonial">
                    ...
                    <div style="display:flex;align-items:center;gap:10px">
                        mg src="https://images.unsplash.com/photo-1546456073-6712f79251bb?auto=format&fit=crop&w=80&q=80" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit:cover">
                        <div>
        ...
        <section class="section container" aria-labelledby="news-title">
            <div class="newsletter" id="newsletter">
                ...
                <form id="newsletterForm" style="display:flex;justify-content:center;gap:8px;flex-wrap:wrap;" onsubmit="return false;">
                    nput id="newsletterEmail" type="email" placeholder="Enter your email" aria-label="Email address" required>
        ...
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                ...
                <div style="margin-top:14px;display:flex;gap:10px">
                    <a class="icon-btn" href="#" title="Facebook"> class="fab fa-facebook"></em></a>
                    <a class="icon-btn" href="#" title="Twitter"> class="fab fa-twitter"></em></a>
                    <a class="icon-btn" href="#" title="Instagram"> class="fab fa-instagram"></em></a>
                </div>
            </div>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon"> class="fas ${cat.icon}"></em></div>
                    <h4>${cat.name}</h4>
        ...
        function renderProducts(list) {
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    ...
                    mg src="${p.img}" alt="${escapeHtml(p.title)}">
                    ...
                    <div class="product-footer">
                        <button class="add-btn" data-id="${p.id}"> class="fas fa-cart-plus"></em> Add</button>
                        <button class="wish-btn" aria-label="Add to wishlist"> class="far fa-heart"></em></button>
                    </div>
                `;
