    ...
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                <button class="mobile-toggle" id="mobileToggle" aria-label="Open menu"> class="fas fa-bars"></i></button>
                <a class="brand" href="#">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Primary navigation">
                <ul>
                    <li><a href="#"> class="fas fa-home"></i> Home</a></li>
                    <li class="has-dropdown" aria-haspopup="true">
                        <a href="#" id="catMenuBtn"> class="fas fa-th-large"></i> Categories  class="fas fa-chevron-down" style="font-size:12px;"></i></a>
                    </li>
                    <li><a href="#"> class="fas fa-fire"></i> Trending</a></li>
                    <li><a href="#deals"> class="fas fa-tag"></i> Deals</a></li>
                    <li><a href="#about"> class="fas fa-info-circle"></i> About</a></li>
                </ul>
            </nav>
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <div class="search" role="search" aria-label="Product search">
                    ...
                    <button class="icon-btn" id="searchBtn" aria-label="Search"> class="fas fa-search"></i></button>
                </div>

                <div class="header-actions" role="group" aria-label="Header actions">
                    <a class="icon-btn" title="Account" href="#"> class="far fa-user"></i></a>
                    <a class="icon-btn" title="Wishlist" href="#"> class="far fa-heart"></i></a>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                ...
                <div>
                    <button class="btn btn-primary" id="shopNow">Shop Now  class="fas fa-arrow-right"></i></button>
        ...
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                ...
                <div style="margin-top:14px;display:flex;gap:10px">
                    <a class="icon-btn" href="#" title="Facebook"> class="fab fa-facebook"></i></a>
                    <a class="icon-btn" href="#" title="Twitter"> class="fab fa-twitter"></i></a>
                    <a class="icon-btn" href="#" title="Instagram"> class="fab fa-instagram"></i></a>
                </div>
            </div>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon"> class="fas ${cat.icon}"></i></div>
                    <h4>${cat.name}</h4>
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    ...
                    <div class="product-footer">
                        <button class="add-btn" data-id="${p.id}"> class="fas fa-cart-plus"></i> Add</button>
                        <button class="wish-btn" aria-label="Add to wishlist"> class="far fa-heart"></i></button>
                    </div>
                `;
